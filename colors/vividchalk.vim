...
"rover changed White to Grey, which is the foreground color of LineNr.
"highlight LineNr        guifg=#DDEEFF ctermfg=White
highlight LineNr        guifg=#DDEEFF ctermfg=Grey
"rover changed DarkBlue to Black, which is the background color of LineNr.
